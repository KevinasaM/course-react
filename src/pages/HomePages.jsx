      ...
      <header className="w-100 min-vh-100 d-flex align-items-center overflow-hidden">
        <Container>
          <Row className='header-box d-flex align-items-center'>
            <Col lg='6'>
            <h1 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Temukan <br/> <span>Bakat Codingmu</span> <br/> Bersama Kevin!</h1>
            <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <button className='btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s' onClick={() => navigate('/kelas')}>Tengok Kelas</button>
